...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: q3t59J6BzNMN/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__jpJlL)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__zxQzt)}
              role={"img"}
            />
          ),
